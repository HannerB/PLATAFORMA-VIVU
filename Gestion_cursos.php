...
if ($_SESSION['alianza']==2 || $valores>0){echo '<button  class="btn btn-danger ml-2" data-bs-toggle="modal" data-bs-target="#staticBackdropconcertaciones" >Mis Concertaciones</button>';}
...
while ($row = $query->fetch_object()) {
  ...
  $query2 = $mysqli->query($consulta2);
    ...
    echo '<button class="gfgdelete btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target="#staticBackdropDelete"><span ></span>Borrar</button>
