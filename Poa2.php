...
<table id="tabla" class="table table-striped">
      ...
      while ($row = $query->fetch_object()) {
        ...
        echo '<tr> 
                    ...
                    <td>';
                    if ($_SESSION['alianza']==0){}else{echo '<button class="gfgselect btn btn-primary btn-xs" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><span ></span>Editar</button>
                    ...
                    echo '
                    <a href=Gestion_cursos2.php?id='.$row->id_poa.' <button class="gfg btn btn-warning btn-xs" ><span ></span>Ver Cursos</button></a> 
