...
<?php if(!empty($user)): ?>
    ...
    <div class="mt-2 PopUpContainer">
        <div class="contentContainer text-success">
            <ol class="breadcrumb"><li><a class="text-success" href="index.php">Inicio</a></li><li><a class="text-success" href="micuenta.php">Mi cuenta</a></li><li class="active text-success">Registrar Aprendiz</li></ol>
        </div>
        <!-- ====== PopUpLogin ======-->
                            ...
                            <div class="full-width">
                                <form class="simple_form mt-2" id="frmGuardarAprendiz">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <button type="button" id="btnGuardarAprendiz" class="btn btn-outline-success btn-block">Registrar Aprendiz</button>
                                    </div>
                                    </div>
                                </form>   
